...
#define TFT_CS_LOW      digitalWrite(7, LOW)
#define TFT_CS_HIGH     digitalWrite(7, HIGH)
#define TFT_BL_OFF      digitalWrite(3, LOW)
#define TFT_BL_ON       digitalWrite(3, HIGH)
#else
#define TFT_DC_LOW      digitalWrite(6, LOW)
#define TFT_DC_HIGH     digitalWrite(6, HIGH)
...
public:
    ...
    void fillScreen_random(INT16U XL,INT16U XR,INT16U YU,INT16U YD);
    
    
	void fillScreen(void);
    void fillScreen(INT16U color);
    void fillRectangle_t(INT16U poX, INT16U poY, INT16U length, INT16U width, INT16U color);
